...
[Ruby on Rails 3 & 4: Руководство по стилю оформления][rails-style-guide].
...
например, ["Programming Ruby 1.9"][pickaxe] и ["Язык программирования Ruby"][trpl]
...
[RuboCop][] &mdash; это анализатор кода,
...
* <a name="begin-implicit"></a> Используйте *неявный begin* где возможно.<sup>[[ссылка](#begin-implicit)]</sup>
...
* <a name="no-gappy-arrays"></a> Не создавайте массивы с большими пробелами.<sup>[[ссылка](#no-gappy-arrays)]</sup>

  ```Ruby
  arr = []
  arr[100] = 1 # получаем массив с кучей нулей
  ```

* <a name="first-and-last"></a> При доступе к первому или последнему эллементу массива используйте,  `first` или `last` нежели `[0]` или `[-1]`.<sup>[[ссылка](#first-and-last)]</sup>
